...
type ShipmentServiceClient interface {
	...
	AddShipmentEvent(ctx context.Context, in *AddShipmentEventRequest, opts ...grpc.CallOption) (*ShipmentEvent, error)
	GetShipmentHistory(ctx context.Context, in *GetShipmentHistoryRequest, opts ...grpc.CallOption) (*ShipmentHistoryResponse, error)
}
...
func (c *shipmentServiceClient) AddShipmentEvent(ctx context.Context, in *AddShipmentEventRequest, opts ...grpc.CallOption) (*ShipmentEvent, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *shipmentServiceClient) GetShipmentHistory(ctx context.Context, in *GetShipmentHistoryRequest, opts ...grpc.CallOption) (*ShipmentHistoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShipmentHistoryResponse)
...
type ShipmentServiceServer interface {
	...
	AddShipmentEvent(context.Context, *AddShipmentEventRequest) (*ShipmentEvent, error)
	GetShipmentHistory(context.Context, *GetShipmentHistoryRequest) (*ShipmentHistoryResponse, error)
...
func (UnimplementedShipmentServiceServer) AddShipmentEvent(context.Context, *AddShipmentEventRequest) (*ShipmentEvent, error) {
	return nil, status.Error(codes.Unimplemented, "method AddShipmentEvent not implemented")
}
func (UnimplementedShipmentServiceServer) GetShipmentHistory(context.Context, *GetShipmentHistoryRequest) (*ShipmentHistoryResponse, error) {
